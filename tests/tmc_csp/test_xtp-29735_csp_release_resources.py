...
def csp_subarray_empty(subarray_node_real_csp_low, event_recorder):
...
def tmc_subarray_empty(subarray_node_real_csp_low, event_recorder):
    """Checks if SubarrayNode's obsState attribute value is EMPTY"""
    assert event_recorder.has_change_event_occurred(
        subarray_node_real_csp_low.subarray_node, "obsState", ObsState.EMPTY
    )
