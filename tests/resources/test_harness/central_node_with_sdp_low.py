...
class CentralNodeSdpWrapperLow(CentralNodeWrapperLow):
    """A wrapper class to implement common tango specific details
    and standard set of commands for TMC Low CentralNode with real sdp device,
    defined by the SKA Control Model."""

    def __init__(self) -> None:
        super().__init__()
        self.processor1 = DeviceProxy(processor1)
        device_dict_low["cbf_subarray1"] = "low-sdp/subarray/01"
        device_dict_low["cbf_controller"] = "low-sdp/control/0"
    ...
    def move_to_on(self):
        ...
        self.sdp_master.adminMode = 0
        self.sdp_subarray1.adminMode = 0
